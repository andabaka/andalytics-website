...
```{r, echo=FALSE, fig.cap="Vegetation-climate relationships across Croatia", fig.align="center"}
knitr::include_graphics("images/croatia_bivariate_2d.png")
```
...
```{r prepare_3d_elements, eval=FALSE}
...
```{r, echo=FALSE, fig.cap="3D bivariate map showing vegetation-climate relationships across Croatia", fig.align="center"}
knitr::include_graphics("images/croatia_bivariate_3d.png")
```
