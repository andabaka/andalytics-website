...
```{r folder-structure, echo=FALSE, out.width='80%', fig.cap="Transforming 452 excel files into a single, analysis-ready dataset. This automated workflow takes approximately 5 minutes to process."}
knitr::include_graphics("images/folders-to-results.jpeg")
```
...
```{r extract_coordinates, eval=FALSE}
...
```{r map-plots, class.output="plot-output-container", fig.cap="Spatial distribution of 452 forest plots across four management units in Croatia",  out.width='80%'}
