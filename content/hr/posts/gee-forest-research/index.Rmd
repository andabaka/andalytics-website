...
```{r convert_to_ee, dependson="load_coordinates"}
#------------------------------------------------
...
```{r load_sentinel, dependson="convert_to_ee"}
#-------------------------------------------------
...
```{r vis_params, dependson="load_sentinel"}
#--------------------------------------------
...
```{r map_visualization, dependson=c("load_sentinel", "vis_params", "convert_to_ee")}
#-----------------------------
...
```{r calculate_ndvi, dependson="load_sentinel"}
#---------------------------------------------------
...
```{r ndvi_visualization, dependson=c("calculate_ndvi", "convert_to_ee")}
...
```{r extract_ndvi, dependson=c("calculate_ndvi", "load_coordinates")}
#-------------------------------------------
...
```{r ndvi_interactive_viz, dependson=c("extract_ndvi", "load_coordinates")}
#------------------------------------------------------
...
```{r ndvi_distribution, fig.cap="Distribution of NDVI values across forest management units", out.width="70%", dependson="ndvi_interactive_viz"}
#--------------------------------------------------
...
```{r forest_cover_analysis, dependson="convert_to_ee"}
#--------------------------------------------------
...
```{r forest_cover_viz, dependson="forest_cover_analysis"}
...
```{r loss_analysis, dependson=c("forest_cover_analysis", "extract_ndvi")}
#--------------------------------------------------
...
```{r temporal_analysis, class.output="plot-output-container",fig.cap=" Patterns of forest loss events across management units from 2000 to 2022", out.width="70%", dependson="loss_analysis"}
#--------------------------------------------------
...
```{r disturbance_map, dependson=c("temporal_analysis", "load_coordinates")}
...
```{r load_climate, dependson="convert_to_ee"}
#--------------------------------------------------
...
```{r single_plot_analysis, out.width="70%", fig.cap= "Monthly maximum and minimum temperatures (°C) from 2014 to 2023 for a representative forest plot", dependson=c("climate_processing_function", "load_climate")}
#--------------------------------------------------
...
```{r precipitation_analysis, fig.cap="Monthly precipitation totals (mm) from 2014 to 2023 for a representative forest plot", out.width="70%", dependson="single_plot_analysis"}
...
```{r seasonal_analysis, fig.cap="Average monthly temperature and precipitation patterns from 2014 to 2023", out.width="70%", dependson="single_plot_analysis"}
...
```{r process_all_plots, eval = FALSE, dependson=c("climate_processing_function", "load_coordinates")}
#--------------------------------------------------
...
```{r batch_processing, dependson="process_all_plots"}
#--------------------------------------------------
